...
class HomeController extends Controller
{
    public function Index()
    {
        ...
        $Tests = Learner::all();
        return view('home.index', compact('banners', 'academics', 'Departments', 'first_dept', 'first_course', 'FAQs', 'IgnouTubes', 'Testimonials', 'DropdownQualifications', 'DropdownsProgramorCourses', 'DropdownsReasons', 'Tests','Impressions'));
    }
